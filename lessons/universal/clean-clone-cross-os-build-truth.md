...
- Pairs with [[content-guard-honors-gitignore]]: what the repo commits, and what it merely happens to contain locally, are different sets — gates should reason about the former.
