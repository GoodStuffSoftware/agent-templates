...
- The same ranking applies to identifiers, not just versions: the installed artifact beats the documentation, and two researchers disagreeing about one is a reason to go read it ([[grep-the-shipped-artifact-not-the-docs]]).
