...
| `premium_cap` | Caps concurrent premium-tier subagents at `premium_max_concurrent`, counted by tier: a spawn whose route names opus needs no warrant but still counts. | yes, at the cap |
